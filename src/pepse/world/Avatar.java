...
/**
 * This class represents the Avatar character in the game.
 */
public class Avatar extends GameObject {
    ...
    /**
     * This method represents the collision of the avatar in the game, specific with the Ground.
     *
     * @param other     - other object to collide with.
     * @param collision - collision object for collision logic.
     *                  If the avatar collides with the ground we will set his speed to zero.
     */
    @Override
    ...
    /**
     * This method is responsible for updating the avatar movement in the game.
     *
