...
/**
 * This class represents a Leaf (of the tree) in the game.
 */
public class Leaf extends Block {
    ...
    /**
     * This method is responsible for creating a Transition for the Horizontal velocity change.
     *
    ...
    private Transition<Float> setHorizontalVelocityTransition() {
        ...
        return new Transition<>(
                ...
                LEAF_HORIZONTAL_VELOCITY_TRANSITION_TIME,  // transition fully over five seconds
    ...
    void setAngleTransition() {
        new Transition<>(
                ...
                Transition.CUBIC_INTERPOLATOR_FLOAT,  // use a cubic interpolator
                LEAF_ANGLE_TRANSITION_TIME,  // transition fully over one second
                Transition.TransitionType.TRANSITION_BACK_AND_FORTH,
                null);  // nothing further to execute upon reaching final value
    }
    ...
    void setShrinkageTransition() {
        new Transition<>(
                ...
                LEAF_SHRINKAGE_TRANSITION_TIME,  // transition fully over one second
                Transition.TransitionType.TRANSITION_BACK_AND_FORTH,
                null);  // nothing further to execute upon reaching final value
    }
     ...
     * and sets 'isLeafFallBefore' flag to true after fade out done.
     */
    ...
    /**
     * This method represents the collision case of the leaf with the ground
     *
