...
/**
 * This class is responsible for generating a Tree in the game.
 */
public class TreeGenerator {
    ...
    /**
     * This method is responsible for creating the trunk of a single Tree.
     *
     * @param xTrunkLeft - int, coordinate in which we will start to build the trunk
     * @return Vector2 - vector2 that represents the end of the trunk (will be use for build the tree top)
    ...
    /**
     * This method is responsible for building the tree top of each tree.
     *
